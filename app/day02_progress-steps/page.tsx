...
export default function ProgressSteps() {
  ...
  return (
    <div className="bg-[#f1f1f1] font-body flex items-center justify-center h-screen overflow-hidden m-0">
      <div className="text-center">
        ...
        <button className={styles.btn} disabled={count <= 1} onClick={handlePrev}>Prev</button>
        <button className={styles.btn} disabled={count>=4} onClick={handleNext}>Next</button>
      </div>
    </div>
  )
}
